...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Lesson'), array('action' => 'editLesson', $lesson['Lesson']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Lesson'), array('action' => 'deleteLesson', $lesson['Lesson']['id']), null, __('Are you sure you want to delete # %s?', $lesson['Lesson']['id'])); ?> </li>
